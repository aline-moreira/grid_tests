...
# pdf("iperf_benchmark.pdf", width=10)
...
png("iperf_benchmark_en.png", width=1000)
...
#system("for f in *.pdf; do gs -sDEVICE=pdfwrite -dCompatibilityLevel=1.4 -dPDFSETTINGS=/default -dNOPAUSE -dQUIET -dBATCH -q -sDEVICE=bbox -dDetectDuplicateImages -dCompressFonts=true -r150 -sOutputFile=$f_test $f; done;")
