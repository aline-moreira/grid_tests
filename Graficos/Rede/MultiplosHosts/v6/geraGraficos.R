...
energy <- fromJSON(file="energy_1927132.json")
...
p1 <- ggplot(data=dt_tests, aes(x=grp, y=consumo, color=as.factor(node)))+
    ...
    #1MB
    geom_rect(mapping=aes(xmin=0.6, xmax=1.5, ymin=170, ymax=450),
              color='black', fill=NA, alpha=0.5) +
    geom_text(aes(x=0.6+(1.5-0.6)/2, y=460, label="1 MB"), size=3, color='black') +
    #5MB
    geom_rect(mapping=aes(xmin=1.6, xmax=2.5, ymin=170, ymax=450),
              color='black', fill=NA, alpha=0.5) +
    geom_text(aes(x=1.6+(2.5-1.6)/2, y=460, label="5 MB"), size=3, color='black') +
    #10MB
    geom_rect(mapping=aes(xmin=2.6, xmax=4.5, ymin=170, ymax=450),
              color='black', fill=NA, alpha=0.5) +
    geom_text(aes(x=2.6+(4.5-2.6)/2, y=460, label="10 MB"), size=3, color='black') +
    #50MB
    geom_rect(mapping=aes(xmin=4.6, xmax=6.5, ymin=170, ymax=450),
              color='black', fill=NA, alpha=0.5) +
    geom_text(aes(x=4.6+(6.5-4.6)/2, y=460, label="50 MB"), size=3, color='black') +
    
    #100MB
    geom_rect(mapping=aes(xmin=6.6, xmax=9.5, ymin=170, ymax=450),
              color='black', fill=NA, alpha=0.5) +
    geom_text(aes(x=6.6+(9.5-6.6)/2, y=460, label="100 MB"), size=3, color='black') +
    
    #500MB
    geom_rect(mapping=aes(xmin=9.6, xmax=11.5, ymin=170, ymax=450),
              color='black', fill=NA, alpha=0.5) +
    geom_text(aes(x=9.6+(11.5-9.6)/2, y=460, label="500 MB"), size=3, color='black') +
    
    #1GB
    geom_rect(mapping=aes(xmin=11.6, xmax=14.5, ymin=170, ymax=450),
              color='black', fill=NA, alpha=0.5) +
    geom_text(aes(x=11.6+(14.5-11.6)/2, y=460, label="1.000 MB"), size=3, color='black') +
    
    #5GB
    geom_rect(mapping=aes(xmin=14.6, xmax=16.5, ymin=170, ymax=450),
              color='black', fill=NA, alpha=0.5) +
    geom_text(aes(x=14.6+(16.5-14.6)/2, y=460, label="5.000 MB"), size=3, color='black') +
    #10GB
    geom_rect(mapping=aes(xmin=16.6, xmax=18.5, ymin=170, ymax=450),
              color='black', fill=NA, alpha=0.5) +
    geom_text(aes(x=16.6+(18.5-16.6)/2, y=460, label="10.000 MB"), size=3, color='black') +
    #50GB
    geom_rect(mapping=aes(xmin=18.6, xmax=19.5, ymin=170, ymax=450),
              color='black', fill=NA, alpha=0.5) +
    geom_text(aes(x=18.6+(19.5-18.6)/2, y=465, label="50.000\nMB"), size=3, color='black') +
    
    #100MB
    geom_rect(mapping=aes(xmin=19.6, xmax=20.5, ymin=170, ymax=450),
              color='black', fill=NA, alpha=0.5) +
    geom_text(aes(x=19.6+(20.5-19.6)/2, y=465, label="100.000\nMB"), size=3, color='black') +
